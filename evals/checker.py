...
from evals.java_type_converter import java_type_converter
from evals.js_typ_converter import js_type_converter
...
def get_possible_answer_type(possible_answer: list) -> type:
